...
const Docena = () => {
  ...
  const precioSimples = 6000;
  const precioDulceDeLeche = 8500;
  ...
  return (
    <div className="container mx-auto p-4 h-screen">
      <div className="flex flex-col justify-center gap-8 items-center bg-gray-100 rounded-lg shadow-md p-8">
        <h1 className="text-3xl md:text-5xl font-bold text-center mb-8 text-brown">Calculadora por Docena</h1>
